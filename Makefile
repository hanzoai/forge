...
GO_TEST_PACKAGES ?= $(filter-out $(shell $(GO) list github.com/hanzoai/git/models/migrations/...) github.com/hanzoai/git/tests/integration/migration-test github.com/hanzoai/git/tests github.com/hanzoai/git/tests/integration,$(shell $(GO) list ./... | grep -v /vendor/))
MIGRATE_TEST_PACKAGES ?= $(shell $(GO) list github.com/hanzoai/git/models/migrations/...)
...
SWAGGER_EXCLUDE := github.com/hanzoai/git/sdk
...
test-integration-compile:
	$(GO) test $(GOTEST_FLAGS) -tags '$(TAGS)' -c -o /dev/null github.com/hanzoai/git/tests/integration

.PHONY: test-integration\#%
test-integration\#%:
	$(GO) test $(GOTEST_FLAGS) -tags '$(TAGS)' -run $(subst .,/,$*) github.com/hanzoai/git/tests/integration
...
migrations.integration.test:
	$(GO) test $(GOTEST_FLAGS) -tags '$(TAGS)' github.com/hanzoai/git/tests/integration/migration-test
...
.PHONY: migrations.individual.test\#%
migrations.individual.test\#%:
	$(GO) test $(GOTEST_FLAGS) -tags '$(TAGS)' github.com/hanzoai/git/models/migrations/$*
