...
import (
	...
	"github.com/hanzoai/git/modules/indexer/issues/bleve"
	"github.com/hanzoai/git/modules/indexer/issues/db"
	"github.com/hanzoai/git/modules/indexer/issues/elasticsearch"
	"github.com/hanzoai/git/modules/indexer/issues/internal"
	"github.com/hanzoai/git/modules/indexer/issues/meilisearch"
		...
		case "bleve":
			defer func() {
				if err := recover(); err != nil {
					...
					log.Error("You can completely remove the %q directory to make Hanzo Git recreate the indexes", setting.Indexer.IssuePath)
					globalIndexer.Store(dummyIndexer)
