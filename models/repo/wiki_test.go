...
func TestRepository_WikiCloneLink(t *testing.T) {
	...
	assert.Equal(t, "ssh://sshuser@git.example.com:3000/user2/repo1.wiki.git", cloneLink.SSH)
	assert.Equal(t, "https://git.example.com/user2/repo1.wiki.git", cloneLink.HTTPS)
}
