...
function initPageThemeDarkLight() {
  ...
  const sync = () => document.documentElement.setAttribute('data-hanzo-theme-dark', String(isDarkTheme()));
  sync();
  // Track system theme changes in case the site is using "auto" theme.
