...
import (
	...
	db "github.com/hanzoai/git/models/db"
...
func buildWorkflowTestRepo(t *testing.T) string {
	...
	fmt.Fprintf(&sb, "commit refs/heads/main\nmark :4\nauthor Test <test@forge.example> 1000000000 +0000\ncommitter Test <test@forge.example> 1000000000 +0000\ndata 14\ninitial commit\nM 100644 :1 README.md\n\n")
	fmt.Fprintf(&sb, "commit refs/heads/feature\nmark :5\nauthor Test <test@forge.example> 1000000001 +0000\ncommitter Test <test@forge.example> 1000000001 +0000\ndata 12\nadd workflow\nfrom :4\nM 100644 :2 .hanzo/workflows/my-workflow.yml\n\n")
	fmt.Fprintf(&sb, "reset refs/pull/42/merge\nfrom :5\n\n")
	fmt.Fprintf(&sb, "commit refs/heads/main\nmark :6\nauthor Test <test@forge.example> 1000000002 +0000\ncommitter Test <test@forge.example> 1000000002 +0000\ndata 16\nrelease workflow\nfrom :4\nM 100644 :3 .hanzo/workflows/my-workflow.yml\n\n")
