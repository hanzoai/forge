...
import (
	...
	"github.com/hanzoai/git/routers/api/v1/activitypub"
	"github.com/hanzoai/git/routers/api/v1/admin"
	"github.com/hanzoai/git/routers/api/v1/misc"
	"github.com/hanzoai/git/routers/api/v1/notify"
	"github.com/hanzoai/git/routers/api/v1/org"
	"github.com/hanzoai/git/routers/api/v1/packages"
	"github.com/hanzoai/git/routers/api/v1/repo"
	"github.com/hanzoai/git/routers/api/v1/settings"
	"github.com/hanzoai/git/routers/api/v1/token"
	"github.com/hanzoai/git/routers/api/v1/user"
...
func checkDeprecatedAuthMethods(ctx *context.APIContext) {
	if ctx.FormString("token") != "" || ctx.FormString("access_token") != "" {
		ctx.Resp.Header().Set("X-Git-Warning", "token and access_token API authentication is deprecated and will be removed in Hanzo Git 1.23. Please use AuthorizationHeaderToken instead. Existing queries will continue to work but without authorization.")
	}
}
	...
	m.Group("", func() {
		...
		m.Group("/repos", func() {
			...
			m.Group("/{username}/{reponame}", func() {
				...
				m.Delete("/pull-mirror", reqToken(), reqOwner(), repo.ConvertPullMirror)
