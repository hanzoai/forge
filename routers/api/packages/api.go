...
import (
	...
	"github.com/hanzoai/git/routers/api/packages/cargo"
	"github.com/hanzoai/git/routers/api/packages/chef"
	"github.com/hanzoai/git/routers/api/packages/composer"
	"github.com/hanzoai/git/routers/api/packages/conan"
	"github.com/hanzoai/git/routers/api/packages/conda"
	"github.com/hanzoai/git/routers/api/packages/container"
	"github.com/hanzoai/git/routers/api/packages/cran"
	"github.com/hanzoai/git/routers/api/packages/debian"
	"github.com/hanzoai/git/routers/api/packages/generic"
	"github.com/hanzoai/git/routers/api/packages/goproxy"
	"github.com/hanzoai/git/routers/api/packages/helm"
	"github.com/hanzoai/git/routers/api/packages/maven"
	"github.com/hanzoai/git/routers/api/packages/npm"
	"github.com/hanzoai/git/routers/api/packages/nuget"
	"github.com/hanzoai/git/routers/api/packages/pub"
	"github.com/hanzoai/git/routers/api/packages/pypi"
	"github.com/hanzoai/git/routers/api/packages/rpm"
	"github.com/hanzoai/git/routers/api/packages/rubygems"
	"github.com/hanzoai/git/routers/api/packages/swift"
	"github.com/hanzoai/git/routers/api/packages/terraform"
	"github.com/hanzoai/git/routers/api/packages/vagrant"
	...
	return func(ctx *context.Context) {
		if ctx.Data["IsApiToken"] == true {
			...
			if ok { // it's a personal access token but not oauth2 token
				...
				if !scopeMatched {
					ctx.Resp.Header().Set("WWW-Authenticate", `Basic realm="Hanzo Git Package API"`)
