...
import (
	...
	issue_template "github.com/hanzoai/git/modules/issue/template"
	...
	"github.com/hanzoai/git/routers/utils"
...
var pullRequestTemplateCandidates = []string{
	...
	"pull_request_template.yaml",
	"pull_request_template.yml",
	".hanzo/PULL_REQUEST_TEMPLATE.md",
	".hanzo/PULL_REQUEST_TEMPLATE.yaml",
	".hanzo/PULL_REQUEST_TEMPLATE.yml",
	".hanzo/pull_request_template.md",
	".hanzo/pull_request_template.yaml",
	".hanzo/pull_request_template.yml",
