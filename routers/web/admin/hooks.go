...
func DefaultOrSystemWebhooks(ctx *context.Context) {
	...
	sys["Description"] = ctx.Tr("admin.systemhooks.desc", "https://docs.hanzo.ai/usage/webhooks")
	...
	def["Description"] = ctx.Tr("admin.defaulthooks.desc", "https://docs.hanzo.ai/usage/webhooks")
